...
- Garantia de que nenhum participante se auto sorteie.
...
3. O sistema garante que ninguém se sorteie a si mesmo.
4. Caso queira limpar e relizar as operações novamente clique em "Reiniciar"
...
1. Clone o repositório:
   ```bash
   git clone https://github.com/danielbohnn/amigo-secreto
   ```

2. Abra o arquivo `index.html` no navegador para usar a aplicação.
